...
export default function RunScreen() {
  ...
  async function saveRun() {
    ...
    setDistance(0);
    setDuration(0);
    router.push("/runner/(tabs)/history");
  }
...
const styles = StyleSheet.create({
  permissionScreen: { flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 36, gap: 18 },
  ...
  statUnit: { fontSize: 10, fontFamily: "Inter_500Medium", color: "rgba(255,255,255,0.5)", textTransform: "uppercase", letterSpacing: 0.8 },
  ...
  idleSub: { fontSize: 13, fontFamily: "Inter_400Regular", color: "rgba(255,255,255,0.55)", textAlign: "center" },
  mapControls: { position: "absolute", right: 14, gap: 10, alignItems: "center" },
  mapBtn: { width: 42, height: 42, borderRadius: 21, alignItems: "center", justifyContent: "center" },
  bottomControls: { position: "absolute", bottom: 0, left: 0, right: 0, alignItems: "center", justifyContent: "center" },
  row: { flexDirection: "row", alignItems: "center", gap: 14 },
  column: { alignItems: "center", gap: 10 },
  secBtn: { flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 22, paddingVertical: 15, borderRadius: 30, borderWidth: 1 },
  secBtnText: { color: "#fff", fontSize: 14, fontFamily: "Inter_600SemiBold" },
  bigBtn: { width: 72, height: 72, borderRadius: 36, alignItems: "center", justifyContent: "center", shadowColor: "#E8335A", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.55, shadowRadius: 14, elevation: 8 },
  ...
  recPulse: { position: "absolute", top: -3, right: -3, width: 14, height: 14, borderRadius: 7 },
  ...
  modalActions: { flexDirection: "row", gap: 12, marginTop: "auto" as any, paddingBottom: 32 },
  cancelBtn: { flex: 1, paddingVertical: 16, borderRadius: 30, borderWidth: 1, alignItems: "center" },
  cancelText: { fontSize: 15, fontFamily: "Inter_600SemiBold" },
  saveBtn: { flex: 2, flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "center", paddingVertical: 16, borderRadius: 30 },
